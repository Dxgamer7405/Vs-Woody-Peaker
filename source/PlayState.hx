...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'screwball':
				dialogue = CoolUtil.coolTextFile(Paths.txt('screwball/screwballDialogue'));
			case 'knock':
				dialogue = CoolUtil.coolTextFile(Paths.txt('knock/knockDialogue'));
			case 'real-gone':
				dialogue = CoolUtil.coolTextFile(Paths.txt('real-gone/real-goneDialogue'));
		}
		...
		healthBar.createFilledBar(0xFFCC0033, 0xFF0099FF);
		// healthBar
		add(healthBar);
	...
	function endSong():Void
	{
		...
		if (offsetTesting)
		{
			FlxG.sound.playMusic(Paths.music('WoodyMenu'));
			offsetTesting = false;
